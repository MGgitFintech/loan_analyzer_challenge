...
len_of_loans = len(loan_costs)
sum_of_loans = sum(loan_costs)
avg_of_loans = sum_of_loans / len_of_loans

# How many loans are in the list?
# @TODO: Use the `len` function to calculate the total number of loans in the list.
print(f"the number of loans is {len_of_loans}")
...
print(f"the average cost lof loans is {avg_of_loans}")
